...
use panlatent\craft\dingtalk\records\Employee as EmployeeRecord;
...
class Employee extends Element
{
    ...
    {
        return Craft::t('dingtalk', 'Employee');
    }
    ...
    protected static function defineSources(string $context = null): array
    {
        $sources = [
            [
                'key' => '*',
                'label' => Craft::t('dingtalk', 'All Employees'),
                'criteria' => [],
                'hasThumbs' => true,
            ],
    ...
    public function getPrimaryDepartment()
    {
        ...
        return $this->_primaryDepartment = Plugin::$dingtalk->getDepartments()->getDepartmentById($departmentId);
    }
    ...
    public function setDepartments($departments)
    {
        ...
        foreach ($departments as $department) {
            if (is_int($department) || ctype_digit($department)) {
                $department = Plugin::$dingtalk->getDepartments()->getDepartmentById($department);
            }
    ...
    public function afterSave(bool $isNew)
    {
        if ($isNew) {
            ...
            $record = EmployeeRecord::findOne(['id' => $this->id]);
        }
